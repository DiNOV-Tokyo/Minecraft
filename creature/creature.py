...
class Creature(object):
    def __init__(self, mc, width, height, distance=None):
        self.width = width
        self.height = height
    ...
    def spawnEntity(self, entityName, *args):
        a = flatArgs(args)
        id = self.mc.spawnEntity(entityName, self.left+a[0], self.bottom+a[1], self.plane+a[2], "{NoAI:1,Time:-1,Silent:1,Invulnerable:1,NoGravity:1}")
    ...
    def _to3dc(self, x, y, z):
        return (self.left+x, self.bottom+y, self.plane+z)
